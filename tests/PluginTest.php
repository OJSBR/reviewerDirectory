...
/**
 * @file plugins/generic/reviewerDirectory/tests/PluginTest.php
 *
...
class PluginTest extends PKPTestCase
{
    ...
    {
        return [
            \APP\plugins\generic\reviewerDirectory\ReviewerDirectoryHandler::class,
            \APP\plugins\generic\reviewerDirectory\ReviewerDirectoryPlugin::class,
        ];
    }
